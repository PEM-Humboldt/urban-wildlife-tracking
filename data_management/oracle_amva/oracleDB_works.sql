...
(
    ...
    CONSTRAINT tracker_serial_model_un UNIQUE (serial, cd_model),
...
(
    ...
    cd_tracker NUMBER(10,0) NOT NULL, -- tracker? Individual? deployment? (by any of the 3 possibilty we should be able to get the other 2 using the date
